...
export type CrackDesktopIconAction = { type: 'finder'; path: string } | { type: 'reader'; docId: string }
...
export type CrackDesktopIcon = {
	...
	/** Opens Finder at path instead of only updating the main window panel. */
	action?: CrackDesktopIconAction
}
...
const rawclinicDesktop: CrackDesktopIcon[] = [
	...
	},
	{
		...
		left: '4%',
		top: '56%',
		action: { type: 'reader', docId: 'export-bat' },
		panel: {
	...
	},
	{
		...
		left: '72%',
		top: '10%',
		action: { type: 'finder', path: '/' },
		panel: {
			title: 'Macintosh HD',
			tagline: 'Honest filesystem',
			lines: [
				'Before/after ProRAW samples live in Before_After and My_Roll.DNG.',
				'Double-click a folder, then open embedded vs RAW Clinic exports.'
			]
		}
	},
	{
		...
		left: '60%',
		top: '24%',
		action: { type: 'finder', path: '/Before_After' },
		panel: {
			title: 'Before_After/',
			tagline: 'Embedded vs graded',
			lines: [
				'Each scene folder has a before (embedded preview) and after (RAW Clinic export).',
				'Open in Finder or Preview — no Lightroom subscription required.'
			]
		}
	},
	{
		...
		left: '16%',
		top: '18%',
		action: { type: 'finder', path: '/Fuji_LUTs' },
		panel: {
			title: 'Fuji_LUTs/',
	...
	},
	{
		...
		left: '16%',
		top: '60%',
		action: { type: 'finder', path: '/My_Roll.DNG' },
		panel: {
			title: 'My_Roll.DNG',
	...
	},
	{
		...
		left: '4%',
		top: '70%',
		action: { type: 'reader', docId: 'premium-bak' },
		panel: {
	...
	},
	{
		...
		left: '16%',
		top: '74%',
		action: { type: 'reader', docId: 'readme' },
		panel: {
	...
	},
	{
		...
		left: '28%',
		top: '22%',
		action: { type: 'reader', docId: 'deepfusion-cfg' },
		panel: {
	...
	},
	{
		...
		left: '28%',
		top: '54%',
		action: { type: 'reader', docId: 'on-device-key' },
		panel: {
...
const aqiSenseDesktop: CrackDesktopIcon[] = [
	...
	},
	{
		...
		left: '16%',
		top: '18%',
		action: { type: 'reader', docId: 'aqi-scale-cfg' },
		panel: {
			title: 'EPA_Scale.cfg',
	...
	},
	{
		...
		left: '4%',
		top: '70%',
		action: { type: 'reader', docId: 'breathe-del' },
		panel: {
	...
	},
	{
		...
		left: '16%',
		top: '74%',
		action: { type: 'reader', docId: 'aqi-now-bat' },
		panel: {
			title: 'AQI_Now.bat',
			lines: [
				'@echo off',
	...
	},
	{
		...
		left: '28%',
		top: '54%',
		action: { type: 'reader', docId: 'wellness-trash' },
		panel: {
