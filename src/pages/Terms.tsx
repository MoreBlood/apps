...
export default function Terms() {
  return (
    <div className="container">
      ...
      <p>
        By downloading, installing, or using {config.appName} ("the App"), you agree
      ...
      <p>
        ...
        license to use {config.appName} for personal, non-commercial purposes in
      ...
      <p>
        <strong>Your Content:</strong> You retain all rights to photos and
        content you create or edit using the App. We do not claim any ownership
        rights to your content.
      </p>
      <p>
        <strong>Our Content:</strong> The App itself, including its code,
        design, features, and documentation, is protected by copyright and other
      ...
      <div className="important">
        <strong>Important:</strong> {config.appName} is provided "as is" without
      ...
      <p>
        <strong
          >We strongly recommend backing up your photos before editing
          them.</strong
        >
      </p>
      ...
      <p>
        The App provides tools for editing RAW photos. The quality and results
        of edits depend on:
      </p>
      <ul>
      ...
      <p>
        ...
        <Link to="/privacy"> Privacy Policy</Link>, which explains how we handle
        your information (spoiler: we don't collect any personal data).
      </p>

      <h2>8. Updates and Changes</h2>
      <p>
        We may update the App from time to time to add features, fix bugs, or
        improve performance. We may also modify these Terms of Service.
      ...
      <p>
        ...
        We reserve the right to terminate or restrict access to the App for any
        reason, including violation of these terms.
      </p>

      <h2>10. Third-Party Content</h2>
      <p>
        The App may allow you to import third-party content such as LUT files.
        You are responsible for ensuring you have the right to use any
        third-party content with the App.
      </p>

      <h2>11. Apple App Store</h2>
      <p>
        Your use of the App is also subject to Apple's App Store Terms of
        Service. In case of conflict between these terms and Apple's terms,
        Apple's terms take precedence.
      </p>
      ...
      <p>
        ...
        entire agreement between you and us regarding use of the App.
      </p>
