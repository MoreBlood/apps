				...
				items: [
					{
						...
						answer: (
							<Text as="p">
								RAW Clinic is a mobile photo editor for iPhone and iPad that opens and edits RAW camera files directly
								on your device. Adjust exposure, color, and tone with tools tuned for RAW dynamic range — without
								sending your photos to the cloud.
							</Text>
						)
					},
					{
						...
						answer: (
							<Text as="p">
								RAW Clinic runs on iPhone and iPad with a recent version of iOS or iPadOS. Performance is best on
								devices with enough memory for large RAW files; very large files may take longer to preview on older
								hardware. You do not need a Pro model to <Strong>edit</Strong> RAW — only to shoot Apple ProRAW in the
								built-in Camera app (see below in RAW files &amp; editing).
							</Text>
						)
					},
					{
						...
						answer: (
							<Text as="p">
								No. RAW Clinic does not require sign-in. Open the app, grant photo access, and start editing files from
								your library.
							</Text>
						)
					},
					{
						...
						answer: (
							<Text as="p">
								RAW Clinic is available on the App Store. Any pricing, in-app purchases, or trials are shown on the
								store listing before you download.
							</Text>
						)
					}
				]
				...
				items: [
					{
						...
						answer: (
							<Text as="p">
								RAW Clinic opens files your iPhone or iPad already decodes through PhotoKit and Apple&apos;s on-device
								RAW pipeline (Core Image <code>CIRAWFilter</code>) — including Apple ProRAW and DNG, plus many camera
								RAW types. If a file appears in Photos as RAW and opens there, RAW Clinic can usually develop it.
								Proprietary formats iOS cannot decode are not supported.
							</Text>
						)
					},
					{
						...
						answer: (
							<Text as="p">
								No. <Strong>Editing</Strong> and <Strong>capturing</Strong> RAW are different. Any iPhone or iPad that
								runs RAW Clinic can import and grade ProRAW or camera RAW from Photos, Files, or AirDrop — as long as
								iOS supports that file. An iPhone SE or iPad without ProRAW in Apple Camera can still edit shots taken
								on a Pro iPhone or a mirrorless camera.
							</Text>
						)
					},
					{
						...
						answer: (
							<Text as="p">
								...
								with iOS 14.3 or later. Enable it in Settings → Camera → Formats → Apple ProRAW (or ProRAW &amp;
								Resolution Control on newer Pro models). ProRAW is not available on non-Pro iPhones or in Portrait mode.
								See also{' '}
								<Link
					...
					},
					{
						...
						answer: (
							<Text as="p">
								...
								(Canon, FUJIFILM, Nikon, Sony, and others; Apple updates this list over time). If your camera is not
								listed or iOS cannot open the file, RAW Clinic cannot edit it either.
							</Text>
						)
					},
					{
					...
					},
					{
						...
						answer: (
							<Text as="p">
								Yes. Once photos are on your device, editing runs entirely locally. No internet connection is required
								to adjust and export images.
							</Text>
						)
					},
					{
						...
						answer: (
							<Text as="p">
								...
								whether Apple Camera offers ProRAW on your iPhone model. Captured files are processed on your device and
								can be edited in your queue like imports from Photos.
							</Text>
						)
					}
				]
				...
				items: [
					{
						...
						answer: (
							<Text as="p">
								No. Processing happens on your device. RAW Clinic does not upload your library to our servers for
								editing or storage. See the{' '}
								<Link asChild>
						...
						answer: (
							<>
								...
								<ul>
									<li>
										<Text>
											<Strong>Photos</Strong> — to open RAW files and save exports. You do not have to grant access to
											your entire library: iOS lets you allow only the photos you pick. RAW Clinic edits RAW files only
											— not JPEG or HEIC.
										</Text>
									</li>
									<li>
					...
					},
					{
						...
						answer: (
							<Text as="p">
								...
								coordinates written into the saved file&apos;s metadata (for example EXIF). It is not used for ads,
				...
				items: [
					{
						...
						answer: (
							<Text as="p">
								...
								cloud-only items may need to download first. If you allowed access to only selected photos, you can add
								more anytime in iOS Settings → RAW Clinic → Photos, or when the app asks you to pick additional images.
							</Text>
						)
					},
					{
						...
						answer: (
							<Text as="p">
								RAW files are large and memory-intensive. Close other apps, ensure free storage, and allow previews to
								finish loading before applying heavy adjustments. You can also lower preview resolution in the editor
								settings to speed things up. Files above 48&nbsp;MP may still feel sluggish or look softer while editing
								— we are working to improve that, but very large ProRAW frames are demanding on any phone.
							</Text>
						)
					},
					{
						...
						answer: (
							<Text as="p">
								Check that RAW Clinic still has permission to add to your library. Look in the album or recents view
								where you chose to save. If the export failed, free up storage and try again.
							</Text>
						)
					},
					{
				...
				items: [
					{
						...
						answer: (
							<Text as="p">
								AQI Sense is an iOS app that shows live air quality index (AQI) and pollutant readings near you and
								around the world. Browse a feed of saved and nearby stations, explore an interactive map, and open
								detailed station pages with forecasts.
							</Text>
						)
					},
					{
						...
						answer: (
							<Text as="p">
								AQI Sense runs on iPhone and iPad with a recent version of iOS or iPadOS. An internet connection is
								needed to fetch live readings; saved favorites remain available offline in the app.
							</Text>
						)
					},
					{
				...
				items: [
					{
						...
						answer: (
							<Text as="p">
								...
								Index), Sensor.Community, and OpenSenseMap. We do not operate the sensors; we display what those
								providers publish.
							</Text>
						)
					},
					{
						...
						answer: (
							<Text as="p">
								...
								sensors. Pull to refresh on the feed or reopen a station to request the latest reading available from
								the source.
							</Text>
						)
					},
					{
						...
						answer: (
							<Text as="p">
								AQI is calculated from pollutant concentrations using a scale (US EPA, China HJ 633, European CAQI,
								etc.). Different apps may use different scales, providers, or nearest stations. Pick the provider and
								scale that match how you want to interpret the numbers in Settings.
							</Text>
						)
					},
					{
				...
				items: [
					{
						...
						answer: (
							<Text as="p">
								Open a station&apos;s detail screen and add it to favorites (or use the favorite control on the card,
								depending on your app version). Saved stations appear in your feed for quick access.
							</Text>
						)
					},
					{
						...
						answer: (
							<Text as="p">
								When many stations are close together, the map groups them into a cluster marker showing a count. Zoom
								in or tap the cluster to split it into individual stations.
							</Text>
						)
					},
					{
					...
					},
					{
						...
						answer: (
							<Text as="p">
								...
								When supported by the provider, you may also see multi-day forecasts for ozone, particulates, and UV
								index.
							</Text>
						)
					},
					{
						...
						answer: (
							<Text as="p">
								Use search to look up a place name or keyword, then open stations from the results or map. You can
								favorite any station for your feed regardless of where you are physically located.
							</Text>
						)
					}
				]
			},
			{
				...
				items: [
					...
					},
					{
						...
						answer: (
							<Text as="p">
								The app may request location to show nearby stations on the feed and map. Location is used to improve
								local results, not to sell data. You can control permission in iOS Settings at any time.
							</Text>
						)
					}
				]
				...
				items: [
					{
						...
						answer: (
							<Text as="p">
								The sensor or upstream provider may be offline. Try pull-to-refresh, switch provider in Settings if
								another network covers the area, or check another nearby station.
							</Text>
						)
					},
					{
						...
						answer: (
							<Text as="p">
								Ensure location permission is granted and location services are enabled. Coverage varies by region —
								rural areas may have fewer community sensors. Search manually or zoom the map to find the closest
								available station.
							</Text>
						)
					},
